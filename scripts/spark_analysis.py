...
# Load Data
logs_df = spark.read.csv("data/listening_logs.csv", header=True, inferSchema=True)
songs_df = spark.read.csv("data/songs_metadata.csv", header=True, inferSchema=True)
